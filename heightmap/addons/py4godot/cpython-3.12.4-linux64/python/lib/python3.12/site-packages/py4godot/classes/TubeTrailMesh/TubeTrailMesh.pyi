...
class TubeTrailMesh(__primitivemesh__.PrimitiveMesh):
  ...
  @property
  def radial_steps(self)->int: pass
  @radial_steps.setter
  def radial_steps(self,  value:int)->None: pass
  @property
  ...
  @property
  def section_rings(self)->int: pass
  @section_rings.setter
  def section_rings(self,  value:int)->None: pass
  @property
  ...
  def set_radial_steps(self, radial_steps:int)->None: pass

  def get_radial_steps(self)->int: pass
  ...
  def set_section_rings(self, section_rings:int)->None: pass

  def get_section_rings(self)->int: pass
