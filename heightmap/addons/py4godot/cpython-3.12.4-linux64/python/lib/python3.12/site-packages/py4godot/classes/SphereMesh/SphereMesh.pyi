...
class SphereMesh(__primitivemesh__.PrimitiveMesh):

  @staticmethod
  def constructor()->SphereMesh:pass



  @staticmethod
  def cast(other:__object__.Object)->SphereMesh:pass
  ...
  @property
  def is_hemisphere(self)->bool: pass
  @is_hemisphere.setter
  def is_hemisphere(self,  value:bool)->None: pass
  ...
  def set_is_hemisphere(self, is_hemisphere:bool)->None: pass

  def get_is_hemisphere(self)->bool: pass
