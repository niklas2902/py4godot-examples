...
class AStar3D(__refcounted__.RefCounted):

  @staticmethod
  def constructor()->AStar3D:pass



  @staticmethod
  def cast(other:__object__.Object)->AStar3D:pass
  ...
  def add_point(self, id:int, position:__core__.Vector3, weight_scale:float=1.0)->None: pass

  def get_point_position(self, id:int)->__core__.Vector3: pass

  def set_point_position(self, id:int, position:__core__.Vector3)->None: pass
  ...
  def get_closest_point(self, to_position:__core__.Vector3, include_disabled:bool=False)->int: pass

  def get_closest_position_in_segment(self, to_position:__core__.Vector3)->__core__.Vector3: pass

  def get_point_path(self, from_id:int, to_id:int, allow_partial_path:bool=False)->__core__.PackedVector3Array: pass
