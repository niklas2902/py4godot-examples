...
class WebSocketMultiplayerPeer(__multiplayerpeer__.MultiplayerPeer):
  ...
  @property
  def handshake_timeout(self)->float: pass
  @handshake_timeout.setter
  def handshake_timeout(self,  value:float)->None: pass
  @property
  def max_queued_packets(self)->int: pass
  @max_queued_packets.setter
  def max_queued_packets(self,  value:int)->None: pass
  def create_client(self, url:str, tls_client_options:__tlsoptions__.TLSOptions= __tlsoptions__.TLSOptions.constructor())->int: pass

  def create_server(self, port:int, bind_address:str= __core__.String.new0(), tls_server_options:__tlsoptions__.TLSOptions= __tlsoptions__.TLSOptions.constructor())->int: pass

  def get_peer(self, peer_id:int)->__websocketpeer__.WebSocketPeer: pass

  def get_peer_address(self, id:int)->str: pass

  def get_peer_port(self, id:int)->int: pass
  ...
  def get_handshake_timeout(self)->float: pass

  def set_handshake_timeout(self, timeout:float)->None: pass

  def set_max_queued_packets(self, max_queued_packets:int)->None: pass
