...
import py4godot.classes.CharacterBody3D.CharacterBody3D as __characterbody3d__
...
class CharacterBody3D(__physicsbody3d__.PhysicsBody3D):
  ...
  @property
  def up_direction(self)->__core__.Vector3: pass
  @up_direction.setter
  def up_direction(self,  value:__core__.Vector3)->None: pass
  @property
  ...
  def get_up_direction(self)->__core__.Vector3: pass

  def set_up_direction(self, up_direction:__core__.Vector3)->None: pass
  ...
  def get_floor_normal(self)->__core__.Vector3: pass

  def get_wall_normal(self)->__core__.Vector3: pass

  def get_last_motion(self)->__core__.Vector3: pass

  def get_position_delta(self)->__core__.Vector3: pass

  def get_real_velocity(self)->__core__.Vector3: pass

  def get_floor_angle(self, up_direction:__core__.Vector3= __core__.Vector3.new0())->float: pass

  def get_platform_velocity(self)->__core__.Vector3: pass

  def get_platform_angular_velocity(self)->__core__.Vector3: pass

  def get_slide_collision_count(self)->int: pass

  def get_slide_collision(self, slide_idx:int)->__kinematiccollision3d__.KinematicCollision3D: pass

  def get_last_slide_collision(self)->__kinematiccollision3d__.KinematicCollision3D: pass
