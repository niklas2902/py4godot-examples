...
class DampedSpringJoint2D(__joint2d__.Joint2D):
  ...
  @property
  def rest_length(self)->float: pass
  @rest_length.setter
  def rest_length(self,  value:float)->None: pass
  @property
  ...
  def set_rest_length(self, rest_length:float)->None: pass

  def get_rest_length(self)->float: pass
