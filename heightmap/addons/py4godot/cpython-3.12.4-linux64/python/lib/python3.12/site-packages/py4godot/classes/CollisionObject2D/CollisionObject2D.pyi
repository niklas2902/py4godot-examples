...
class CollisionObject2D(__node2d__.Node2D):
  input_event: BuiltinSignal
  mouse_entered: BuiltinSignal
  mouse_exited: BuiltinSignal
  mouse_shape_entered: BuiltinSignal
  mouse_shape_exited: BuiltinSignal

  @staticmethod
  def constructor()->CollisionObject2D:pass



  @staticmethod
  def cast(other:__object__.Object)->CollisionObject2D:pass
  ...
  @property
  def input_pickable(self)->bool: pass
  @input_pickable.setter
  def input_pickable(self,  value:bool)->None: pass
  def _input_event(self, viewport:__viewport__.Viewport, event:__inputevent__.InputEvent, shape_idx:int)->None: pass

  def _mouse_enter(self)->None: pass

  def _mouse_exit(self)->None: pass

  def _mouse_shape_enter(self, shape_idx:int)->None: pass

  def _mouse_shape_exit(self, shape_idx:int)->None: pass
  ...
  def set_pickable(self, enabled:bool)->None: pass

  def is_pickable(self)->bool: pass
  ...
  def shape_owner_set_transform(self, owner_id:int, transform:__core__.Transform2D)->None: pass

  def shape_owner_get_transform(self, owner_id:int)->__core__.Transform2D: pass
  ...
  def shape_owner_set_one_way_collision(self, owner_id:int, enable:bool)->None: pass

  def is_shape_owner_one_way_collision_enabled(self, owner_id:int)->bool: pass

  def shape_owner_set_one_way_collision_margin(self, owner_id:int, margin:float)->None: pass

  def get_shape_owner_one_way_collision_margin(self, owner_id:int)->float: pass

  def shape_owner_add_shape(self, owner_id:int, shape:__shape2d__.Shape2D)->None: pass

  def shape_owner_get_shape_count(self, owner_id:int)->int: pass

  def shape_owner_get_shape(self, owner_id:int, shape_id:int)->__shape2d__.Shape2D: pass
