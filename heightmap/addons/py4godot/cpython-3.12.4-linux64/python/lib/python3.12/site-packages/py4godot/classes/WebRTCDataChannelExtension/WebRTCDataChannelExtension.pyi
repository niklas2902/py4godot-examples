...
class WebRTCDataChannelExtension(__webrtcdatachannel__.WebRTCDataChannel):
  ...
  def _set_write_mode(self, p_write_mode:int )->None: pass

  def _get_write_mode(self)->int: pass

  def _was_string_packet(self)->bool: pass

  def _get_ready_state(self)->int: pass

  def _get_label(self)->str: pass

  def _is_ordered(self)->bool: pass

  def _get_id(self)->int: pass

  def _get_max_packet_life_time(self)->int: pass

  def _get_max_retransmits(self)->int: pass

  def _get_protocol(self)->str: pass

  def _is_negotiated(self)->bool: pass

  def _get_buffered_amount(self)->int: pass
