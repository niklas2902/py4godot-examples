...
class NavigationAgent3D(__node__.Node):
  ...
  @staticmethod
  def constructor()->NavigationAgent3D:pass



  @staticmethod
  def cast(other:__object__.Object)->NavigationAgent3D:pass
  ...
  @property
  def path_height_offset(self)->float: pass
  @path_height_offset.setter
  def path_height_offset(self,  value:float)->None: pass
  @property
  ...
  @property
  def keep_y_velocity(self)->bool: pass
  @keep_y_velocity.setter
  def keep_y_velocity(self,  value:bool)->None: pass
  @property
  ...
  def set_path_height_offset(self, path_height_offset:float)->None: pass

  def get_path_height_offset(self)->float: pass

  def set_use_3d_avoidance(self, enabled:bool)->None: pass

  def get_use_3d_avoidance(self)->bool: pass

  def set_keep_y_velocity(self, enabled:bool)->None: pass

  def get_keep_y_velocity(self)->bool: pass
  ...
  def set_target_position(self, position:__core__.Vector3)->None: pass
  ...
  def get_next_path_position(self)->__core__.Vector3: pass

  def set_velocity_forced(self, velocity:__core__.Vector3)->None: pass
  ...
  def get_current_navigation_result(self)->__navigationpathqueryresult3d__.NavigationPathQueryResult3D: pass

  def get_current_navigation_path(self)->__core__.PackedVector3Array: pass
  ...
  def get_final_position(self)->__core__.Vector3: pass
