...
import py4godot.classes.PhysicalBone3D.PhysicalBone3D as __physicalbone3d__
...
class PhysicalBone3D(__physicsbody3d__.PhysicsBody3D):
  ...
  @property
  def joint_type(self)->int: pass
  @joint_type.setter
  def joint_type(self,  value:int)->None: pass
  @property
  def joint_offset(self)->__core__.Transform3D: pass
  @joint_offset.setter
  def joint_offset(self,  value:__core__.Transform3D)->None: pass
  @property
  def joint_rotation(self)->__core__.Vector3: pass
  @joint_rotation.setter
  def joint_rotation(self,  value:__core__.Vector3)->None: pass
  @property
  def body_offset(self)->__core__.Transform3D: pass
  @body_offset.setter
  def body_offset(self,  value:__core__.Transform3D)->None: pass
  @property
  def mass(self)->float: pass
  @mass.setter
  def mass(self,  value:float)->None: pass
  @property
  def friction(self)->float: pass
  @friction.setter
  def friction(self,  value:float)->None: pass
  @property
  def bounce(self)->float: pass
  @bounce.setter
  def bounce(self,  value:float)->None: pass
  @property
  ...
  def _integrate_forces(self, state:__physicsdirectbodystate3d__.PhysicsDirectBodyState3D)->None: pass

  def apply_central_impulse(self, impulse:__core__.Vector3)->None: pass

  def apply_impulse(self, impulse:__core__.Vector3, position:__core__.Vector3= __core__.Vector3.new0())->None: pass

  def set_joint_type(self, joint_type:int )->None: pass

  def get_joint_type(self)->int: pass

  def set_joint_offset(self, offset:__core__.Transform3D)->None: pass

  def get_joint_offset(self)->__core__.Transform3D: pass

  def set_joint_rotation(self, euler:__core__.Vector3)->None: pass

  def get_joint_rotation(self)->__core__.Vector3: pass

  def set_body_offset(self, offset:__core__.Transform3D)->None: pass

  def get_body_offset(self)->__core__.Transform3D: pass

  def get_simulate_physics(self)->bool: pass

  def is_simulating_physics(self)->bool: pass

  def get_bone_id(self)->int: pass

  def set_mass(self, mass:float)->None: pass

  def get_mass(self)->float: pass

  def set_friction(self, friction:float)->None: pass

  def get_friction(self)->float: pass

  def set_bounce(self, bounce:float)->None: pass

  def get_bounce(self)->float: pass
  ...
  def set_linear_velocity(self, linear_velocity:__core__.Vector3)->None: pass

  def get_linear_velocity(self)->__core__.Vector3: pass

  def set_angular_velocity(self, angular_velocity:__core__.Vector3)->None: pass
