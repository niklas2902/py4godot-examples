...
class StyleBoxLine(__stylebox__.StyleBox):
  ...
  @property
  def grow_begin(self)->float: pass
  @grow_begin.setter
  def grow_begin(self,  value:float)->None: pass
  @property
  def grow_end(self)->float: pass
  @grow_end.setter
  def grow_end(self,  value:float)->None: pass
  @property
  def thickness(self)->int: pass
  @thickness.setter
  def thickness(self,  value:int)->None: pass
  @property
  ...
  def set_thickness(self, thickness:int)->None: pass

  def get_thickness(self)->int: pass

  def set_grow_begin(self, offset:float)->None: pass

  def get_grow_begin(self)->float: pass

  def set_grow_end(self, offset:float)->None: pass

  def get_grow_end(self)->float: pass
