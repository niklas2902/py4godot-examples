...
class RenderSceneBuffersConfiguration(__refcounted__.RefCounted):
  ...
  @property
  def render_target(self)->__core__.RID: pass
  @render_target.setter
  def render_target(self,  value:__core__.RID)->None: pass
  @property
  def internal_size(self)->__core__.Vector2i: pass
  @internal_size.setter
  def internal_size(self,  value:__core__.Vector2i)->None: pass
  @property
  def target_size(self)->__core__.Vector2i: pass
  @target_size.setter
  def target_size(self,  value:__core__.Vector2i)->None: pass
  @property
  def view_count(self)->int: pass
  @view_count.setter
  def view_count(self,  value:int)->None: pass
  @property
  ...
  @property
  def fsr_sharpness(self)->bool: pass
  @fsr_sharpness.setter
  def fsr_sharpness(self,  value:bool)->None: pass
  @property
  def texture_mipmap_bias(self)->bool: pass
  @texture_mipmap_bias.setter
  def texture_mipmap_bias(self,  value:bool)->None: pass
  def get_render_target(self)->__core__.RID: pass

  def set_render_target(self, render_target:__core__.RID)->None: pass

  def get_internal_size(self)->__core__.Vector2i: pass

  def set_internal_size(self, internal_size:__core__.Vector2i)->None: pass

  def get_target_size(self)->__core__.Vector2i: pass

  def set_target_size(self, target_size:__core__.Vector2i)->None: pass

  def get_view_count(self)->int: pass

  def set_view_count(self, view_count:int)->None: pass
  ...
  def set_msaa_3d(self, msaa_3d:int )->None: pass
