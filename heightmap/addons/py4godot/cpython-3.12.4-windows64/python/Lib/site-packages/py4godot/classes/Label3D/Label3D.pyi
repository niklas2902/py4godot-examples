...
import py4godot.classes.Label3D.Label3D as __label3d__
...
class Label3D(__geometryinstance3d__.GeometryInstance3D):
  ...
  @property
  def outline_render_priority(self)->int: pass
  @outline_render_priority.setter
  def outline_render_priority(self,  value:int)->None: pass
  @property
  def modulate(self)->__core__.Color: pass
  @modulate.setter
  def modulate(self,  value:__core__.Color)->None: pass
  @property
  def outline_modulate(self)->__core__.Color: pass
  @outline_modulate.setter
  def outline_modulate(self,  value:__core__.Color)->None: pass
  @property
  ...
  @property
  def outline_size(self)->int: pass
  @outline_size.setter
  def outline_size(self,  value:int)->None: pass
  @property
  ...
  def set_outline_modulate(self, modulate:__core__.Color)->None: pass

  def get_outline_modulate(self)->__core__.Color: pass
  ...
  def set_outline_render_priority(self, priority:int)->None: pass

  def get_outline_render_priority(self)->int: pass

  def set_font(self, font:__font__.Font)->None: pass

  def get_font(self)->__font__.Font: pass

  def set_font_size(self, size:int)->None: pass

  def get_font_size(self)->int: pass

  def set_outline_size(self, outline_size:int)->None: pass

  def get_outline_size(self)->int: pass
