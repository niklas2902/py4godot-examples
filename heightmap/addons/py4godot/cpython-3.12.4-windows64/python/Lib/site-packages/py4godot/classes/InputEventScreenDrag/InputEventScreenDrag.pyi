...
class InputEventScreenDrag(__inputeventfromwindow__.InputEventFromWindow):

  @staticmethod
  def constructor()->InputEventScreenDrag:pass



  @staticmethod
  def cast(other:__object__.Object)->InputEventScreenDrag:pass


  @property
  def index(self)->int: pass
  @index.setter
  def index(self,  value:int)->None: pass
  @property
  ...
  def set_index(self, index:int)->None: pass
