...
class World3D(__resource__.Resource):

  @staticmethod
  def constructor()->World3D:pass



  @staticmethod
  def cast(other:__object__.Object)->World3D:pass
  ...
  @property
  def fallback_environment(self)->__environment__.Environment: pass
  @fallback_environment.setter
  def fallback_environment(self,  value:__environment__.Environment)->None: pass
  @property
  ...
  @property
  def space(self)->__core__.RID: pass
  @property
  def navigation_map(self)->__core__.RID: pass
  @property
  def scenario(self)->__core__.RID: pass
  @property
  def direct_space_state(self)->__physicsdirectspacestate3d__.PhysicsDirectSpaceState3D: pass
  def get_space(self)->__core__.RID: pass

  def get_navigation_map(self)->__core__.RID: pass

  def get_scenario(self)->__core__.RID: pass
  ...
  def set_fallback_environment(self, env:__environment__.Environment)->None: pass

  def get_fallback_environment(self)->__environment__.Environment: pass

  def set_camera_attributes(self, attributes:__cameraattributes__.CameraAttributes)->None: pass

  def get_camera_attributes(self)->__cameraattributes__.CameraAttributes: pass

  def get_direct_space_state(self)->__physicsdirectspacestate3d__.PhysicsDirectSpaceState3D: pass
