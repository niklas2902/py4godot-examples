...
class NavigationPathQueryResult2D(__refcounted__.RefCounted):
  ...
  @property
  def path(self)->__core__.PackedVector2Array: pass
  @path.setter
  def path(self,  value:__core__.PackedVector2Array)->None: pass
  @property
  ...
  def set_path(self, path:__core__.PackedVector2Array)->None: pass

  def get_path(self)->__core__.PackedVector2Array: pass
