...
class NavigationRegion2D(__node2d__.Node2D):
  navigation_polygon_changed: BuiltinSignal
  bake_finished: BuiltinSignal

  @staticmethod
  def constructor()->NavigationRegion2D:pass



  @staticmethod
  def cast(other:__object__.Object)->NavigationRegion2D:pass


  @property
  def navigation_polygon(self)->__navigationpolygon__.NavigationPolygon: pass
  @navigation_polygon.setter
  def navigation_polygon(self,  value:__navigationpolygon__.NavigationPolygon)->None: pass
  @property
  ...
  def set_navigation_polygon(self, navigation_polygon:__navigationpolygon__.NavigationPolygon)->None: pass

  def get_navigation_polygon(self)->__navigationpolygon__.NavigationPolygon: pass
  ...
  def bake_navigation_polygon(self, on_thread:bool=True)->None: pass
