...
class PrismMesh(__primitivemesh__.PrimitiveMesh):
  ...
  @property
  def left_to_right(self)->float: pass
  @left_to_right.setter
  def left_to_right(self,  value:float)->None: pass
  @property
  ...
  @property
  def subdivide_height(self)->int: pass
  @subdivide_height.setter
  def subdivide_height(self,  value:int)->None: pass
  @property
  def subdivide_depth(self)->int: pass
  @subdivide_depth.setter
  def subdivide_depth(self,  value:int)->None: pass
  def set_left_to_right(self, left_to_right:float)->None: pass

  def get_left_to_right(self)->float: pass

  def set_size(self, size:__core__.Vector3)->None: pass

  def get_size(self)->__core__.Vector3: pass

  def set_subdivide_width(self, segments:int)->None: pass

  def get_subdivide_width(self)->int: pass

  def set_subdivide_height(self, segments:int)->None: pass

  def get_subdivide_height(self)->int: pass

  def set_subdivide_depth(self, segments:int)->None: pass
